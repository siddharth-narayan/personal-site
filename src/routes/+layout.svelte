...
<div class="flex flex-col h-full">
    ...
    <div class="border-t border-secondary flex sticky mt-8 justify-between">
        <div class="w-[25vw]"></div>
        <div class="flex w-[30vw] justify-around">
            
            <a href="/" class=" hover:text-accent flex content-center p-4 transition-all transition-duration: 150ms;">Home</a>
            <a href="/blog/" class=" hover:text-accent flex gap-2 p-4 transition-all transition-duration: 150ms;">
